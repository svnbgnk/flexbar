...
/*
		...
		a.mismatches       = 0;
                a.gapsPrefix       = 0;
                a.mismatchesPrefix = 0;
                //TODO add option to only count from clipped sequence
		...
		for(; it1 != end(row1); ++it1){
			...
			if((a.startPos <= alPos && alPos < a.endPos || true) && posSeq2 < prefix){
                            if(isGap(it1))
                            {
                                ++a.gapsPrefix;
                            }
...
/*
                cout << "alPos: " << alPos << "\n";
                cout << "posSeq2: " << posSeq2 << "\n";
		cout << "a.gapsPrefix: " << a.gapsPrefix << "\n";
                cout << "a.mismatchesPrefix: " << a.mismatchesPrefix << "\n";*/
